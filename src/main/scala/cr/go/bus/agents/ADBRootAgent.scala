...
/**
  * This class implements a Root agent.
  */
class ADBRootAgent extends ADBAbstractAgent with ADBForwardRouter with ADBBackwardsRouter
  ...
  /**
    ...
    */
  override val rest = {
    respondWithSingletonHeader(RawHeader("Root agent", "host: %s, port: %s".format(agentHost, agentPort)))
